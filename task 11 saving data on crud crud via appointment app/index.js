...
function gettingdata(e){
   ...
   axios.post("https://crudcrud.com/api/c51797fa4e754058b6bf985eabb455db/apointment_datas",obj)
   .then((res)=>{
...
window.addEventListener("DOMContentLoaded",()=>{
  ...
  axios.get("https://crudcrud.com/api/c51797fa4e754058b6bf985eabb455db/apointment_datas")
  .then((res)=>{
...
function deleteing(userid){
   axios.delete(`https://crudcrud.com/api/c51797fa4e754058b6bf985eabb455db/apointment_datas/${userid}`)
   .then((res)=>{
